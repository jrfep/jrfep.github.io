...
aIDs <- album_info %>% filter(title %in% c("Lugares - México", "Lugares - Europa", "Lugares - Sur América", "Eventuales")) %>% pull(id)
...
lugares <- c("Lugares - Europa", "Lugares - Sur América", "Lugares - México")
